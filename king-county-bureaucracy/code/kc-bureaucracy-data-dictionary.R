...
data_dictionary <- tibble::tribble(
   ...
   "Abbreviation",                                         "The official acronym",  "http://directory.kingcounty.gov/",                                                                                                         NA,
    "Description",                                 "A description of the purpose",  "http://directory.kingcounty.gov/",                                                                                                         NA,
         "Parent",  "The level of goverment underwhich this public office exists",  "http://directory.kingcounty.gov/",                                                                                                         NA,
     ...
     "Department",          "The Department underwhich this public office exists",  "http://directory.kingcounty.gov/",                                                                                                         NA
  )
